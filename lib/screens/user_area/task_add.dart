...
class TaskAddFormState extends State<TaskAddForm> {
  ...
  final String _creationDateHour = '';
  ...
  void updateTaskPriority(String taskPriority) {
    setState(() {
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: NameInput(onNameChanged: updateTitle, hintName: "Title"),
                          ),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 20),
                          Expanded(
                            child: NameInput(onNameChanged: updateFinishDateHour, hintName: "Finish Date&Hour"),
                          ),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 20),
                          Expanded(
                            child: NameInput(onNameChanged: updateTaskPriority, hintName: "Task Priority"),
                          ),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 20),
                          Expanded(
                            child: NameInput(onNameChanged: updateDescription, hintName: "Description (PRECISA DE SCROLLBAR E MULTI-LINHA)"),
                          ),
                        ],
                      ),
                    ),
                    ...
                    child: TextButton(
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          // Add event logic
                          // For now (no backend done for add tasks), only go to main screen
                          Navigator.pushReplacementNamed(context, '/main_screen');
                        } else {
                          showDialog(
                            context: context,
